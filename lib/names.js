/*
 * 
 * Taken from http://leapon.net/en/random-name-generator-javascript
 * All credits to Leontius Adhika Pradhana
 */
...
function getName(minlength, maxlength, prefix, suffix)
{
    ...
    var length = random(minlength, maxlength) - prefix.length - suffix.length;
